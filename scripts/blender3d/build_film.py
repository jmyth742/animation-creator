...
film_cast.apply_walk(orig, walk_pair(OP, (6.6, 16.5)), WALK2_START, FRAMES,   # up the path toward the hall, clear of the painted lake
               fps=FPS, stride_hz=1.15)
film_cast.apply_walk(nrig, walk_pair(NP, (5.0, 17.3)), WALK2_START, FRAMES,
