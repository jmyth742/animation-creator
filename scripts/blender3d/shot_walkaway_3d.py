"""
The walk-away shot in the REAL 3D valley: scene geometry, toon materials,
a sun that draws the character's shadow on the grass, occlusion that is
true rather than painted.

Run: blender -b --factory-startup --python shot_walkaway_3d.py -- \
       <mesh.glb> <sheet.png> <outdir>
"""
import sys
import math
import bpy
...
mesh_path, sheet_path, outdir = sys.argv[-3:]
FPS, FRAMES = 16, 81
